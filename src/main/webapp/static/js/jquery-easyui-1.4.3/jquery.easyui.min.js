...
_225.find("div.panel-tool .panel-tool-a").appendTo(opts.mapTools);
}
_225.empty();
...
if(opts.mapTools){
if($.isArray(opts.mapTools)){
$.map(opts.mapTools,function(t){
_227(tool,t.iconCls,eval(t.handler));
});
}else{
$(opts.mapTools).children().each(function(){
...
$(opts.mapTools).addClass("tabs-tool").appendTo(_317);
$(opts.mapTools).show();
}else{
...
tool.linkbutton($.extend({},opts.mapTools[i],{plain:true}));
}
}
}else{
_317.children("div.tabs-tool").remove();
...
$(opts.mapTools).children().appendTo(_352);
}
...
$.fn.tabs.defaults={width:"auto",height:"auto",headerWidth:150,tabWidth:"auto",tabHeight:27,selected:0,showHeader:true,plain:false,fit:false,border:true,justified:false,narrow:false,pill:false,mapTools:null,toolPosition:"right",tabPosition:"top",scrollIncrement:100,scrollDuration:400,onLoad:function(_383){
...
p.panel($.extend({},$.fn.layout.paneldefaults,{cls:("layout-expand layout-expand-"+dir),title:"&nbsp;",closed:true,minWidth:0,minHeight:0,doSize:false,mapTools:[{iconCls:icon,handler:function(){
_3c2(_3b3,_3b4);
return false;
}}]}));
