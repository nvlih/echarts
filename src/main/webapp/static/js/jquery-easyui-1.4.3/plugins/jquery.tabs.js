...
if(_f.mapTools){
if(typeof _f.mapTools=="string"){
$(_f.mapTools).addClass("tabs-tool").appendTo(_10);
$(_f.mapTools).show();
}else{
...
var tr=_11.find("tr");
for(var i=0;i<_f.mapTools.length;i++){
var td=$("<td></td>").appendTo(tr);
var _12=$("<a href=\"javascript:void(0);\"></a>").appendTo(td);
_12[0].onclick=eval(_f.mapTools[i].handler||function(){
});
_12.linkbutton($.extend({},_f.mapTools[i],{plain:true}));
}
}
}else{
_10.children("div.tabs-tool").remove();
...
if($.isArray(_55.mapTools)){
_59.empty();
for(var i=0;i<_55.mapTools.length;i++){
var t=$("<a href=\"javascript:void(0)\"></a>").appendTo(_59);
t.addClass(_55.mapTools[i].iconCls);
if(_55.mapTools[i].handler){
t.bind("click",{handler:_55.mapTools[i].handler},function(e){
...
$(_55.mapTools).children().appendTo(_59);
}
...
$.fn.tabs.defaults={width:"auto",height:"auto",headerWidth:150,tabWidth:"auto",tabHeight:27,selected:0,showHeader:true,plain:false,fit:false,border:true,justified:false,narrow:false,pill:false,mapTools:null,toolPosition:"right",tabPosition:"top",scrollIncrement:100,scrollDuration:400,onLoad:function(_95){
